...
import { Checkbox, Component, setComponentManager, escapeExpression, getTemplates, Helper, helper, htmlSafe, isHTMLSafe, LinkComponent, setTemplates, template, TextField, TextArea, Input, isSerializationFirstNode } from '@ember/-internals/glimmer'; // eslint-disable-next-line import/no-unresolved
...
import { componentCapabilities, modifierCapabilities, helperCapabilities, setModifierManager, setComponentTemplate, getComponentTemplate, setHelperManager } from '@glimmer/manager';
...
/* EMBER_MODERNIZED_BUILT_IN_COMPONENTS */
  ...
  [['Checkbox', '@ember/component/checkbox', Checkbox], ['TextField', '@ember/component/text-field', TextField], ['TextArea', '@ember/component/text-area', TextArea], ['LinkComponent', '@ember/routing/link-component', LinkComponent], ['TextSupport', '@ember/-internals/views', views.TextSupport]].forEach(([name, path, value]) => {
    Object.defineProperty(Ember, name, {
      get() {
        deprecate(`Using Ember.${name} or importing from '${path}' has been deprecated, install the ` + `\`ember-legacy-built-in-components\` addon and use \`import { ${name} } from ` + `'ember-legacy-built-in-components';\` instead`, false, {
